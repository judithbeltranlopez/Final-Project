...
```{r standard-plot, out.width='80%', fig.align='center', fig.cap='Great figure!', fig.height=4,warning=FALSE}
library(readxl)
library(dplyr)
library(ggplot2)
...
```
```{r standard-plot2, out.width='80%', fig.align='center', fig.cap='School Population', fig.height=4,warning=FALSE}
library(janitor)
library(tidyverse)
library(dplyr)
library(sf)
...
```{r standard-plot3, out.width='80%', fig.align='center', fig.cap='Resident Population by Travel Mode', fig.height=4,warning=FALSE,message=FALSE}
library(sf)
library(dplyr)
library(gstat)
library(stars)
