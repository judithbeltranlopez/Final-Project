...
```{r standard-plot1, out.width='80%', fig.align='center', fig.cap='Great figure!', fig.height=4}
library(janitor)
library(tidyverse)
...
```
```{r standard-plot2, out.width='80%', fig.align='center', fig.cap='School Population', fig.height=4}
library(janitor)
library(tidyverse)
library(dplyr)
library(sf)
...
```{r standard-plot3, out.width='80%', fig.align='center', fig.cap='Resident Population by Travel Mode', fig.height=4}
library(sf)
library(dplyr)
library(gstat)
library(stars)
